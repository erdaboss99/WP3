                    ...
                    <form method="POST" action="{{ route('vehicles.update', $vehicle->id) }}">
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            <div>
                                ...
                                <x-input id="brand" class="block mt-1 w-full" type="text" name="brand" value="{{ $vehicle->brand }}" autofocus />
                            </div>
                            <div>
                                <x-label for="model" :value="__('Model')" />
                                <x-input id="model" class="block mt-1 w-full" type="text" name="model" value="{{ $vehicle->model }}" autofocus />
                            </div>
                            <div>
                                <x-label for="odometer" :value="__('Odometer')" />
                                <x-input id="odometer" class="block mt-1 w-full" type="text" name="odometer" value="{{ $vehicle->odometer }}" autofocus />
                            </div>
                            <div>
